...
def installNode():
    ...
    if if_exist_fisco == "no":
        ...
        gitComm = "wget http://res.zhonghui.vip/blockchain/fisco-bcos/01/resource//build_chain.sh && chmod u+x build_chain.sh".format(fisco_version)
...
def installWeb():
    ...
    os.chdir(currentDir)
    web_version = getCommProperties("webase.web.version")
    gitComm = "wget http://res.zhonghui.vip/blockchain/fisco-bcos/01/resource/webase-web.zip ".format(web_version)
    pullSourceExtract(gitComm,"webase-web")
    web_h5_enable = int(getCommProperties("web.h5.enable"))
    if web_h5_enable == 1:
        gitComm = "wget http://res.zhonghui.vip/blockchain/fisco-bcos/01/resource/webase-web-mobile.zip ".format(web_version)
...
def installManager(visual_deploy=False):
    ...
    mgr_version = getCommProperties("webase.mgr.version")
    encrypt_type = int(getCommProperties("encrypt.type"))
    gitComm = "wget http://res.zhonghui.vip/blockchain/fisco-bcos/01/resource/webase-node-mgr.zip ".format(mgr_version)
...
def installFront():
    ...
    os.chdir(currentDir)
    front_version = getCommProperties("webase.front.version")
    gitComm = "wget http://res.zhonghui.vip/blockchain/fisco-bcos/01/resource/webase-front.zip ".format(front_version)
...
def installSign():
    ...
    os.chdir(currentDir)
    sign_version = getCommProperties("webase.sign.version")
    gitComm = "wget http://res.zhonghui.vip/blockchain/fisco-bcos/01/resource/webase-sign.zip".format(sign_version)
